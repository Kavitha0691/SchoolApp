...
const CreatePage = () => {
    ...
    return (
        <div className="border-1 rounded-xl p-4 w-[600px] mx-auto">
            <h2 className="font bold text-3xl mb-6">Got something to say !</h2>
            ...
            <form onSubmit={handleSubmit(values => {
                ...
                <fieldset >
                    <label htmlFor="title" >Post Titlel</label>
                    <input className="ml-2 mb-4 px-2" {...register("title")} id="title" placeholder="Enter Your Email" />
